...
> アイデア出しに慣れていない学生チームが、課題整理からアイデア決定までを迷わず進められることをMVPの中心価値とする。
> MVP は、ルーム準備の後に **デザインスプリント形式**（課題整理 → 問いの作成 → アイデア決定）で進行する。
...
6. [MVP: ルーム準備とデザインスプリントフロー](#6-mvp-ルーム準備とデザインスプリントフロー)
7. [コア機能一覧](#7-コア機能一覧)
8. [競合との差別化](#8-競合との差別化)
9. [プロダクトメッセージ](#9-プロダクトメッセージ)
...
> アイデア出しに慣れていない学生チームが、迷わずアイデアを出し、整理し、1つに絞るための Web アプリ。

### エレベーターピッチ

Idea Boost は、ハッカソン・ビジネスコンテスト・授業やサークルのチーム制作で使う、**学生チーム向けのアイデア創出支援 Web アプリ**です。

チームの初期に起きる「何を作ればいいか分からない」「アイデアが出ない」「どれを選べばいいか分からない」を、議論の進め方ごと支援します。

Miro や FigJam のような自由なホワイトボードとは異なり、**デザインスプリント形式の進行フロー**をアプリに組み込みます。ここでいうデザインスプリントとは、課題を整理し、問いを作り、アイデアを比較して決定するための決まった手順です。各ステップのガイドとタイマーが進め方を示し、チームをアイデア決定まで案内します。

| 項目         | 内容                                                                                                    |
| ------------ | ------------------------------------------------------------------------------------------------------- |
| 対象         | アイデア出しやファシリテーションに慣れていない学生チーム                                                  |
| 製品         | デザインスプリント形式のアイデア創出支援 Web アプリ                                                     |
| 解決する問題 | チームで「何を作るか」を決めるまでの進め方が分からない                                                  |
| できること   | 固定の進行フローとファシリテーションガイドに沿って、課題整理からアイデア決定までを1つの流れで進められる |
| 競合との違い | 自由度や機能数ではなく、初学者が迷わず進めるための型を提供する                                           |

---

## 2. 解決したいこと

学生チームでのアイデア出しでは、「何を考えればよいか分からない」「意見が出る人に偏る」「出た案を整理・選定できない」という課題が起きやすい。

本プロダクトは、自由なホワイトボードを提供するだけではなく、**デザインスプリントの型に沿って進められるフレームワーク型のブレスト体験**を提供する。ルーム準備の後、1画面 = 1ワークフェーズとし、フェーズ内は Stepper（タブ）で進行する。各フェーズの最後に成果物を決定することで、初学者でも「今何をすべきか」に迷わず進められるようにする。
...
| 意見が出る人に偏る             | 会議中心の進め方では、事前準備してきた人、書くのが早い人、声の大きい人の意見に偏りやすい。                   | 各フェーズの Step1 を個人専用付箋 + タイマーによる個人ワークとし、書いた付箋は本人にのみ表示される。タイマー終了後に手動でドラッグ＆ドロップして共有スペースへ移動させることで初めて他メンバーに見えるようになり、全員が自分の案を出してから共有に進む構成にする。 |
| アイデアを整理できない         | アイデアが増えるほど全体像が見えにくくなり、似た案や重要な観点を見落としやすい。                             | 課題整理フェーズでは共有ステップでホワイトボード上のグルーピングを行い、アイデアフェーズでは価値 × 実現可能性の2軸マッピングで整理する。                                                                                                                           |
| どの案を選ぶべきか分からない   | 案の良し悪しを話し合う基準が曖昧だと、なんとなくの好みや発言力で決まりやすい。                               | 各決定ステップで「🔴主観ドット×1 + 🔵客観ドット×3」のステルス投票を実施し、主観的な納得感と客観的な比較の両方から絞り込めるようにする。（主観5ポイント・客観1ポイントで計算）                                                                                      |
...
| No. | Goal                                                                                                                                             |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | アイデア出しに慣れていない初学者チームでも、ルーム準備と3つのワークフェーズを、固定フローとファシリテーションガイドに沿って迷わず完走できる |
...
## 6. MVP: ルーム準備とデザインスプリントフロー

本MVPは、ルームを作成・共有する準備と、3つのワークフェーズで構成する。ワークフェーズでは、課題を整理し、課題を問いに変換し、その問いに対するアイデアを比較して1つに決定する。

各ステップの推奨時間を合計すると約78分であり、授業やハッカソンの1セッションとして実施できる規模を想定する。実際の所要時間はチームの人数や議論の状況に応じて変わる。
...
- **ファシリテーションガイドが各ステップを案内**：現在地HUDから開閉できる左側のガイドを既定で展開し、所要時間と参加者向け指示を示す。ホストにだけ進行指示を追加表示する。利用者は折り畳めるが、ステップが変わると再び展開する
- **フェーズ名とステップ名を常に画面表示する**：画面上にフェーズ名とステップ名を両方表示し、今どのフェーズ・ステップにいるかを常に把握できるようにする。フェーズのアイコンは画像ではなく、名前の頭文字2文字で表現する
- **ワークフェーズは3つに整理する**：ルーム準備とは分け、デザインスプリントの大枠フェーズは「課題整理」「問いの作成」「アイデア出し・評価・決定」の3つとする。
...
- **進行はホスト（ルーム作成者）が行う**：次のフェーズ・次のステップへの進行は、一旦ホスト（ルーム作成者）がチェックすることで全員の画面に反映される方式で実装を進める。デザインスプリントは時間を厳守して進める性質が強いため、全員のチェックを待つよりホストの操作を優先する。
- **主要操作と参照情報を見ながら作業できる**：1280×720で主要操作と補助パネルが重ならず、狭い画面でも現在のステップ・進捗・タイマー・次への操作を確認できる。HMW作成時は採用した課題、アイデア作成時は採用したHMWを進め方と同時に参照でき、長文も全文を読める。
- **補助情報を必要に応じて開閉できる**：作業に必要なヒントと採用内容は最初から表示する。進め方・採用内容・ヒント・マイ付箋は独立して開閉でき、閉じても入力内容やキャンバスの表示位置を保つ。マイ付箋は折り畳んで始め、追加時に開く。
- **タイマーとHUDは不透明にする**：開始前・実行中・一時停止・終了でタイマーの寸法と読みやすい背景を維持する。透明効果を減らす設定でもHUDを不透明にし、設定画面もボード内容と混ざらない。
- **タイマーは推奨時間から手動で開始する**：各ステップの推奨時間をタイマーの初期値にするが、自動開始・自動進行は行わない。成功したステップ移行ではタイマーを停止し、次ステップの推奨時間へ戻す
- **最終決定を完了として扱う**：Step 3-5では「次のステップへ」を表示せず、アイデア決定後は全員に「スプリント完了」を表示する
...
- **カーソルに参加者名を表示し、共同作業感を演出する**：他メンバーのカーソル位置には表示名を表示する。ただし、ステルス投票中のカーソルは非表示。
...
| ------------------------ | ---: | ---------------------------------------------- | ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Step1 自分の課題（個人） |  3分 | 個人専用付箋 / タイマー / 1枚につき1テーマ     | 「デザインスプリントを始めよう！まずは最近あった困ったことを、1枚につき1つ付箋に書き出そう。」 | 「タイマーが終了したら、次のステップへ進んでください。」                |
...
| Step4 投票               |  3分 | 🔴主観ドット×1 / 🔵客観ドット×3 / ステルス投票 | 「1人あたり、主観1票・客観3票まで投票できるよ。進行役の指示を待とう！」                        | 「全員の投票が終わったら、次のステップへ進んでください。」              |
| Step5 課題決定           | 10分 | 投票結果表示 / 取り組む課題の確定              | 「投票結果を参考に、取り組む課題をみんなで1つ決めよう。」                                      | 「納得できるまで話し合い、1つに絞れたら次のステップへ進んでください。」 |
...
| Step                          | 時間 | 機能                                                                                                                                                                                                                                                                                                         | 参加者向けガイド                                                         | ホスト限定の進行指示                                                    |
| ----------------------------- | ---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| Step1 課題に対するHMW（個人） |  3分 | 決定した課題を画面上部に固定表示 / 「HMW = どうしたら私たちは、もっと〇〇できるだろう？」の見出しを1回だけ固定表示し、付箋には〇〇部分（問いの本体）のみ入力 / テンプレート（もっと簡単に / もっと安心して / もっと楽しく / もっと短時間で / もっと継続して）を選ぶと入力欄へ挿入 / お手本となる具体例を表示 | 「決定した課題に対するHMWを、付箋に書き出そう。」                        | なし                                                                    |
| Step2 HMW共有                 |  6分 | HMW共有                                                                                                                                                                                                                                                                                                      | 「自分の付箋をドラッグしてみんなに共有しよう。順番を決めて発表しよう。」 | 「全員の共有が終わったら、次のステップへ進んでください。」              |
| Step3 投票                    |  4分 | 🔴主観ドット×1 / 🔵客観ドット×3 / ステルス投票                                                                                                                                                                                                                                                               | 「1人あたり、主観1票・客観3票まで投票できるよ。進行役の指示を待とう！」  | 「全員の投票が終わったら、次のステップへ進んでください。」              |
| Step4 HMW決定                 | 10分 | 投票結果表示 / HMWの確定                                                                                                                                                                                                                                                                                     | 「投票結果を参考に、HMWをみんなで1つ決めよう。」                         | 「納得できるまで話し合い、1つに絞れたら次のステップへ進んでください。」 |
...
| Step                             | 時間 | 機能                                                                                                                                                                     | 参加者向けガイド                                                                                          | ホスト限定の進行指示                                       |
| -------------------------------- | ---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| Step1 アイデアを書き出す（個人） |  3分 | 個人作業 / タイマー / 付箋入力 / サイドバーに発想支援ツール（オズボーンのチェックリスト・SCAMPER・逆転発想・他業界事例）                                                 | 「決定したHMWをもとに、アイデアを付箋に書き出そう。書き終えたら手を止めて待とう。」                       | 「個人ワークの時間を守って進行してください。」             |
...
| Step3 価値×実現可能性で評価      |  7分 | 2軸マッピング（縦軸：選定した課題・HMWへの価値〔上に行くほど高い〕、横軸：実現可能性〔右に行くほど高い〕）／ チームの合意のもと位置を確定／ ホストのみドラッグ可能（案） | 「付箋を動かし、縦軸の「価値」と横軸の「実現可能性」で評価しよう。」                                      | 「評価が終わったら、次のステップへ進んでください。」       |
| Step4 ドット投票                 |  3分 | 🔴主観ドット×1 / 🔵客観ドット×3 / ステルス投票                                                                                                                           | 「1人あたり、主観1票・客観3票まで投票できるよ。進行役の指示を待とう！」                                   | 「全員の投票が終わったら、次のステップへ進んでください。」 |
| Step5 アイデアを決定             | 10分 | 投票結果表示 / 採用アイデアの確定                                                                                                                                        | 「投票結果を参考に、採用するアイデアをみんなで1つ決めよう。」                                             | 「1つに決定したら、デザインスプリントは完了です。」        |
...
| デザインスプリント進行フロー       | ルーム準備と3つのワークフェーズを、1画面1フェーズ・Stepper形式で迷わず進められる                                                   |
| 個人ワーク付箋（タイマー付き）     | 各フェーズの発想ステップで、個人専用の付箋とタイマーにより偏りなく意見を出せる                                                      |
| 共有・グルーピング                 | 出た意見をホワイトボード上で共有し、似た意見をグルーピングして整理できる                                                            |
| ステルス投票（主観×1・客観×3）     | 課題・HMW・アイデアの決定ステップで、他者の投票が見えない形の投票により絞り込める。投票対象はグループではなく常に個々の付箋とする。 |
| 2軸マッピング（価値 × 実現可能性） | アイデアフェーズで、価値と実現可能性の2軸でアイデアを整理・評価できる                                                               |
...
| 主な価値     | 多様な共同作業を1キャンバスで         | ルーム準備と3つのワークフェーズを迷わず進む        |
...
ハッカソン・ビジコン・チーム制作の最初の壁は「何を作るか」。初学者チームがアイデア出しで止まらないように、デザインスプリントの型に沿った進行をサポートします。自由なホワイトボードではなく、次に何をすればよいかが分かる**道案内**を提供します。

### プレゼンでの一文

> Idea Boost は、アイデア出しの進め方が分からない学生チームを、課題整理からアイデア決定まで案内する Web アプリです。
...
- プロダクト名は **Idea Boost** に統一する。「IdeaFlow」は現在の正式名称として使わない。
- MVP の進行支援は固定フロー、ガイド文言、タイマーで実現する。AI ファシリテーターが存在するような表現は使わない。
- 「デザインスプリント」は、初出時に「課題整理 → 問いの作成 → アイデア決定の手順」と説明する。

`docs/images/screen-package-design.png` は過去のコンセプトイメージであり、現在のプロダクト名・MVP範囲・画面仕様の正本ではない。プレゼン資料の素材として使う場合は、現在のPRDと実装画面に合わせて更新する。
...
- 以下のリポジトリ Wiki（インセプションデッキ）
  ...
  - [パッケージデザイン](https://github.com/engineer-first/idea-boost/wiki/パッケージデザイン)（過去のコンセプト資料）
