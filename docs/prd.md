...
- **ファシリテーションガイドが各ステップを案内**：現在地HUDと一体化したガイドを既定で展開し、所要時間と参加者向け指示を示す。ホストにだけ進行指示を追加表示する。利用者は折り畳めるが、ステップが変わると再び展開する
...
- **主観・客観ドットはクリックで固定位置に積み上げる方式とする**：ステルス投票の🔴主観ドット・🔵客観ドットは、付箋上の自由な座標に配置するのではなく、あらかじめ決められた位置にクリックのたびに積み上げて表示する。
